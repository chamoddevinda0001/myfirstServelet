...
<body>
	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				<a href="https://www.javaguides.net" class="navbar-brand"> Online Management App </a>
			</div>
	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<c:if test="${user != null}">
					<input type="hidden" name="idnumber" value="<c:out value='${user.idnumber}' />" />
				</c:if>
				...
				<fieldset class="form-group">
					<label>Occupation</label> <input type="text"
						value="<c:out value='${user.occupation}' />" class="form-control"
						name="occupation">
				</fieldset>
